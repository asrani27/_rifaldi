                ...
                <ul class="nav pcoded-inner-navbar ">
                    ...
                    <li class="nav-item">
                        <a href="/superadmin/jenis" class="nav-link "><span class="pcoded-micon"><i
                                    class="feather icon-list"></i></span><span class="pcoded-mtext">Jenis
                                Usaha</span></a>
                    </li>
                    <li class="nav-item">
                        <a href="/superadmin/perusahaan" class="nav-link "><span class="pcoded-micon"><i
                                    class="feather icon-list"></i></span><span class="pcoded-mtext">Data
                                Perusahaan</span></a>
                    </li>
                    <li class="nav-item">
                        <a href="/superadmin/karyawan" class="nav-link "><span class="pcoded-micon"><i
                                    class="feather icon-list"></i></span><span class="pcoded-mtext">Data
                                Karyawan</span></a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a href="/superadmin/kodefikasi" class="nav-link "><span class="pcoded-micon"><i
                                    class="feather icon-list"></i></span><span class="pcoded-mtext">Data
                                Kodefikasi</span></a>
                    </li>

                    <li class="nav-item">
                        <a href="/superadmin/laporkerja" class="nav-link "><span class="pcoded-micon"><i
                                    class="feather icon-list"></i></span><span class="pcoded-mtext">Data
                                Lapor Kerja</span></a>
                    </li>
                    <li class="nav-item">
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            <div class="page-header-title">
                                <h5 class="m-b-10">Dashboard Aplikasi Lapor Kerja</h5>
                            </div>
                            <ul class="breadcrumb">
